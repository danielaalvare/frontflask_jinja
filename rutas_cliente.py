...
# Crear el Blueprint para agrupar las rutas relacionadas con clientes
...
def clientes():
    """
    Función asociada a la ruta /clientes.
    Retorna la plantilla clientes.html, donde se mostrará el formulario
    y la lista de clientes obtenidos desde la API.
    """
